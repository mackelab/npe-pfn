...
class HodgkinHuxley:
    def __init__(self, I, dt, V0, cython=False, prior_log=False):
        ...
        if cython:
            log.info("Using cython for the Allen HH model")
            import tabpfn_sbi.tasks.allen.HodgkinHuxleyBioPhysCython as bm
        else:
            # potentially add this later
            raise NotImplementedError("Only cython version is supported!")
        self.bm = bm
